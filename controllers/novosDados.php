...
mysqli_query($conexao, "UPDATE usuarios SET usuarioNome='$UsuarioNome', usuarioEmail='$UsuarioEmail', usuarioSenha='$UsuarioSenha', usuarioSexo='$UsuarioSexo' WHERE usuarioId= $UsuarioCodigo");
