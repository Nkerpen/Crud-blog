...
<div id="mainContent" class="text-center d-flex justify-content-center">
    ...
    <div id="lista-noticias" class="mt-5">
        ...
        <table width="700px" class="table table-white table-striped table-hover shadow mt-5 ">
            ...
            <?php
            $query = mysqli_query($conexao, "SELECT * FROM noticias INNER JOIN imgs ON noticiaImgId = imgId INNER JOIN infos ON noticiaInfoId = infoId INNER JOIN usuarios ON noticiaUsuarioId = usuarioId");
